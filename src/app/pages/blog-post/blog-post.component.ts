  ...
  template: `
    <div class="min-h-screen bg-gray-50">
      ...
      <div class="container-custom py-8">
        <div class="max-w-4xl mx-auto">
          <div *ngIf="blogPost$ | async as post; else loadingTemplate" 
               class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 md:p-12">
            <app-blog-post [blogPost]="post"></app-blog-post>
          </div>
          ...
          <div *ngIf="postNotFound" 
               class="bg-white rounded-lg shadow-sm border border-gray-200 p-8 md:p-12 text-center">
            <div class="text-6xl mb-4">📄</div>
            <h2 class="text-2xl font-bold text-gray-900 mb-4">Post Not Found</h2>
            <p class="text-gray-600 mb-6">
              The blog post you're looking for doesn't exist or has been moved.
            </p>
            <a routerLink="/blog" class="btn-primary">
              Back to Blog
            </a>
          </div>
        </div>
        ...
        <div class="max-w-4xl mx-auto">
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <p class="text-gray-600">
              Check out more of my writing on the 
              <a routerLink="/blog" class="text-primary-600 hover:text-primary-700 font-medium">
                blog page
              </a>.
            </p>
          </div>
